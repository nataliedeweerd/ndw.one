	...
	<body>
        ...
        <section class="colour portfolio">
            ...
            <div class="grid grid--effect">
                ...
                <a href="#" class="grid__item grid__item--1-3 grid__item--santa">
                    <div class="stack">
                        <div class="stack__deco"></div>
                        <div class="stack__deco"></div>
                        <div class="stack__deco"></div>
                ...
                <a href="#" class="grid__item grid__item--1-3 grid__item--signin">
                    <div class="stack">
                        <div class="stack__deco"></div>
                        <div class="stack__deco"></div>
                        <div class="stack__deco"></div>
		...
		<script>
		(function() {
			[].slice.call(document.querySelectorAll('.grid--effect > .grid__item')).forEach(function(stackEl) {
				new FolioFx(stackEl);
			});
		})();
		</script>
